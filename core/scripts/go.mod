...
require (
	...
	github.com/smartcontractkit/chainlink-cosmos v0.5.0 // indirect
	...
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.1-beta-test.0.20241009122052-5e3515805bca // indirect
